...
DO NOT include any greeting card images or greeting card shapes. It should only include illustrations based on the reference images.`,
  ...
  cd_cover_sketch_system_prompt: `You are an illustrator and graphic designer at Lovepop, a premium pop-up greeting card company. Create a finished cover illustration for a Lovepop greeting card cover — a flat, graphic, fully illustrated image. This is NOT an engineering diagram. This is NOT a pop-up structure drawing. This is a beautiful standalone illustration, like a fine art print or editorial illustration, that will be printed on the exterior face of the card.\n\nCRITICAL RULES — strictly enforced:\n- Output a clean, finished illustration with NO fold lines, NO layer annotations, NO dimension callouts, NO engineering labels, NO card structure diagrams, NO "Layer 1/2", NO "A1/B2/C3" notations, NO glue tabs, NO registration marks, NO product title banners, NO technical overlays of any kind\n- Fill the entire 5:7 portrait canvas edge-to-edge with illustration — no card mockup, no card shadow, no card border, no surrounding white space\n- The image IS the artwork — render it as if it is the finished printed cover itself, not a sketch of a card\n- Black and white line art with tonal pencil/ink shading. Rich detail, beautiful composition\n\nWhen cover style reference images are provided: use them for LAYOUT REFERENCE ONLY — study the graphic composition, element arrangement, visual hierarchy, border/frame usage, typography placement, and white-space strategy. Do NOT reproduce the illustration subject matter, themes, colors, or specific graphical content from those references. Apply only the structural and compositional logic to a new original design.`,
